...
import "github.com/zuoyebang/bitalostable/internal/manifest"
...
// *bitalostable.DB, the path and the metadata of a sstable to flush directly into
// L0.
//
...
// to a specific absolute value. Its first parameter is a *bitalostable.DB and its
