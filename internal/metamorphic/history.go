...
//
// history also implements the bitalostable.Logger interface, outputting to a stdlib
...
// Infof implements the bitalostable.Logger interface. Note that the output is
// commented.
func (h *history) Infof(format string, args ...interface{}) {
	_ = h.log.Output(2, h.format("// INFO: ", format, args...))
}

// Fatalf implements the bitalostable.Logger interface. Note that the output is
// commented.
