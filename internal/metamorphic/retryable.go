...
func (i *retryableIter) RangeKeys() []bitalostable.RangeKeyData {
...
func (i *retryableIter) NextWithLimit(limit []byte) bitalostable.IterValidityState {
	var validity bitalostable.IterValidityState
	i.withPosition(func() {
		i.withRetry(func() {
			validity = i.iter.NextWithLimit(limit)
			i.updateRangeKeyChangedGuess()
			for validity == bitalostable.IterValid && i.shouldFilter() {
				validity = i.iter.NextWithLimit(limit)
				i.updateRangeKeyChangedGuess()
			}
		})
...
func (i *retryableIter) PrevWithLimit(limit []byte) bitalostable.IterValidityState {
	var validity bitalostable.IterValidityState
	i.withPosition(func() {
		i.withRetry(func() {
...
func (i *retryableIter) SeekGEWithLimit(key []byte, limit []byte) bitalostable.IterValidityState {
	var validity bitalostable.IterValidityState
	i.withPosition(func() {
		i.withRetry(func() { validity = i.iter.SeekGEWithLimit(key, limit) })
		i.updateRangeKeyChangedGuess()
		if validity == bitalostable.IterValid && i.shouldFilter() {
...
func (i *retryableIter) SeekLTWithLimit(key []byte, limit []byte) bitalostable.IterValidityState {
	var validity bitalostable.IterValidityState
	i.withPosition(func() {
...
func (i *retryableIter) SetOptions(opts *bitalostable.IterOptions) {
