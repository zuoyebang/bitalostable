...
const blockPropertyName = `bitalostable.internal.testkeys.suffixes`
...
// bitalostable.BlockPropertyFilterMask for efficient range-key masking using the
...
// SetSuffix implements bitalostable.BlockPropertyFilterMask.
