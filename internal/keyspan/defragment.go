...
func (i *DefragmentingIter) Next() *Span {
	...
	case iterPosPrev:
		...
		if invariants.Enabled && i.iterSpan == nil {
			panic("bitalostable: invariant violation: no next span while switching directions")
		}
	...
	case iterPosCurr:
		...
		if invariants.Enabled && i.iterSpan != nil && !i.iterSpan.Empty() {
			panic("bitalostable: invariant violation: iterPosCurr with valid iterSpan")
		}
...
func (i *DefragmentingIter) Prev() *Span {
	...
	case iterPosNext:
		...
		i.iterSpan = i.iter.Prev()
		if invariants.Enabled && i.iterSpan == nil {
			panic("bitalostable: invariant violation: no previous span while switching directions")
		}
