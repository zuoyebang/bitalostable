...
// the caller (generally bitalostable.Iterator or bitalostable.mergingIter) rather than
...
// optimizations. The bitalostable.Iterator satisfies this requirement by maintaining
...
type InternalIterator interface {
	...
	// error. Note that bitalostable/Iterator.SeekPrefixGE has this same restriction on
...
// absolute-positioning operation from the perspective of the bitalostable.Iterator,
...
type InternalIteratorStats struct {
	...
	// https://github.com/zuoyebang/bitalostable/issues/1070.
