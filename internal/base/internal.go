...
package base // import "github.com/zuoyebang/bitalostable/internal/base"
...
const (
	...
	// https://github.com/zuoyebang/bitalostable/issues/1255.
...
// make up a bitalostable DB.
//
// It consists of the user key (as given by the code that uses package bitalostable)
...
func (k InternalKey) Visible1(snapshot uint64) bool {
	return Visible1(k.SeqNum(), snapshot)
}

func Visible1(seqNum uint64, snapshot uint64) bool {
	return seqNum <= snapshot || (seqNum&InternalKeySeqNumBatch) != 0
}
