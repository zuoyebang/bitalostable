...
import (
	...
	"github.com/zuoyebang/bitalostable/internal/intern"
)
...
type Properties struct {
	...
	NumRangeKeyDels uint64 `prop:"bitalostable.num.range-key-dels"`
	// The number of RANGEKEYSETs in this table.
	NumRangeKeySets uint64 `prop:"bitalostable.num.range-key-sets"`
	// The number of RANGEKEYUNSETs in this table.
	NumRangeKeyUnsets uint64 `prop:"bitalostable.num.range-key-unsets"`
	...
	RawRangeKeyKeySize uint64 `prop:"bitalostable.raw.range-key.key.size"`
	// Total raw rangekey value size.
	RawRangeKeyValueSize uint64 `prop:"bitalostable.raw.range-key.value.size"`
