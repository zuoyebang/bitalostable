...
type lazyCombinedIter struct {
	// parent holds a pointer to the root *bitalostable.Iterator containing this
...
// *bitalostable.Iterator's combinedIterState. This allows them to check whether or
...
func (i *lazyCombinedIter) initCombinedIteration(
	...
	if invariants.Enabled {
		if i.combinedIterState.initialized {
			panic("bitalostable: combined iterator already initialized")
		}
		if i.parent.rangeKey != nil {
			panic("bitalostable: iterator already has a range-key iterator stack")
		}
	}
