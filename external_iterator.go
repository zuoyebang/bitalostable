// Copyright 2022 The LevelDB-Go and Pebble and Bitalostored Authors. All rights reserved. Use
...
func validateExternalIterOpts(iterOpts *IterOptions) error {
	...
	case iterOpts.TableFilter != nil:
		return errors.Errorf("bitalostable: external iterator: TableFilter unsupported")
	case iterOpts.PointKeyFilters != nil:
		return errors.Errorf("bitalostable: external iterator: PointKeyFilters unsupported")
	case iterOpts.RangeKeyFilters != nil:
		return errors.Errorf("bitalostable: external iterator: RangeKeyFilters unsupported")
	case iterOpts.OnlyReadGuaranteedDurable:
		return errors.Errorf("bitalostable: external iterator: OnlyReadGuaranteedDurable unsupported")
	case iterOpts.UseL6Filters:
		return errors.Errorf("bitalostable: external iterator: UseL6Filters unsupported")
	}
	return nil
}
