// Copyright 2018 The LevelDB-Go and Pebble and Bitalostored Authors. All rights reserved. Use
...
func (b *syncedBuffer) Cost(args ...interface{}) func() {
	begin := time.Now()
	return func() {
		s := fmt.Sprint(args...) + base.FmtDuration(time.Now().Sub(begin))
		b.mu.Lock()
		defer b.mu.Unlock()
		b.buf.Write([]byte(s))
...
func (l redactLogger) Info(args ...interface{}) {
	l.logger.Info(redact.Sprint(args...).Redact())
}

func (l redactLogger) Warn(args ...interface{}) {
	l.logger.Warn(redact.Sprint(args...).Redact())
}

func (l redactLogger) Error(args ...interface{}) {
	l.logger.Error(redact.Sprint(args...).Redact())
}
...
func (l redactLogger) Warnf(format string, args ...interface{}) {
	l.logger.Warnf("%s", redact.Sprintf(format, args...).Redact())
}
...
func (l redactLogger) Cost(arg ...interface{}) func() {
	return l.logger.Cost(arg)
}
