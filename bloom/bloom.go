...
package bloom // import "github.com/zuoyebang/bitalostable/bloom"
...
// FilterPolicy implements the FilterPolicy interface from the bitalostable package.
//
...
//
// It is valid to use the other API in this package (bitalostable/bloom) without
// using this type or the bitalostable package.
type FilterPolicy int

// Name implements the bitalostable.FilterPolicy interface.
...
// MayContain implements the bitalostable.FilterPolicy interface.
...
// NewWriter implements the bitalostable.FilterPolicy interface.
